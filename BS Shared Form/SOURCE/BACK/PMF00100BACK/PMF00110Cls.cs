...
namespace PMF00100BACK
{
    public class PMF00110Cls : R_BusinessObject<PMF00110ParameterDTO>
    {
        ...
        RSP_PM_SAVE_ALLOCATION.Resources_Dummy_Class _loRspSave = new RSP_PM_SAVE_ALLOCATION.Resources_Dummy_Class();
        ...
        public GetCallerTrxInfoDTO GetCAWTCustReceipt(GetCallerTrxInfoParameterDTO poParam)
        {
        ...
        public GetCallerTrxInfoDTO GetCQCustReceipt(GetCallerTrxInfoParameterDTO poParam)
        {
