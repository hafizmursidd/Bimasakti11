...
namespace PMF00100COMMON
{
    public interface IPMF00110 : R_IServiceCRUDBase<PMF00110ParameterDTO>
    {
        ...
        GetCallerTrxInfoResultDTO GetCAWTCustReceipt(GetCallerTrxInfoParameterDTO poParam);
        GetCallerTrxInfoResultDTO GetCQCustReceipt(GetCallerTrxInfoParameterDTO poParam);
