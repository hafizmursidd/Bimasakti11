...
namespace PMF00100Model
{
    public class PMF00110Model : R_BusinessObjectServiceClientBase<PMF00110ParameterDTO>, IPMF00110
    {
        ...
        public GetCallerTrxInfoResultDTO GetCAWTCustReceipt(GetCallerTrxInfoParameterDTO poParam)
        {
            throw new NotImplementedException();
        }
        public async Task<GetCallerTrxInfoResultDTO> GetCAWTCustReceiptAsync(GetCallerTrxInfoParameterDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<GetCallerTrxInfoResultDTO, GetCallerTrxInfoParameterDTO>(
                    _RequestServiceEndPoint,
                    nameof(IPMF00110.GetCAWTCustReceipt),
                    poParam,
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
        ...
        public GetCallerTrxInfoResultDTO GetCQCustReceipt(GetCallerTrxInfoParameterDTO poParam)
        {
            throw new NotImplementedException();
        }
        public async Task<GetCallerTrxInfoResultDTO> GetCQCustReceiptAsync(GetCallerTrxInfoParameterDTO poParam)
        {
            R_Exception loEx = new R_Exception();
            GetCallerTrxInfoResultDTO loRtn = null;
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<GetCallerTrxInfoResultDTO, GetCallerTrxInfoParameterDTO>(
                    _RequestServiceEndPoint,
                    nameof(IPMF00110.GetCQCustReceipt),
                    poParam,
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
