    ...
    public class PMR00150Cls
    {
        ...
        public List<PMR00150DataSummaryDbDTO> GetLOCStatusSummaryReportData(PMR00150DBParamDTO poParameter)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCommand, "@CREPORT_TYPE", DbType.String, 6, poParameter.CTO_PERIOD);
                loDb.R_AddCommandParameter(loCommand, "@CTO_PERIOD", DbType.String, 6, poParameter.CREPORT_TYPE);
