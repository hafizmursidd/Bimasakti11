    ...
    public class PMT01700LOO_OfferCls : R_BusinessObject<PMT01700LOO_Offer_SelectedOfferDTO>
    {
        ...
        private void SaveSPMaintainAgreement(ref PMT01700LOO_Offer_SelectedOfferDTO poNewEntity, eCRUDMode poCRUDMode, DbConnection poConnection)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCommand, "@LWITH_FO ", DbType.Boolean, 30, poNewEntity.LWITH_FO );
                loDb.R_AddCommandParameter(loCommand, "@CHAND_OVER_DATE", DbType.String, 20, poNewEntity.CHAND_OVER_DATE);
                loDb.R_AddCommandParameter(loCommand, "@NBOOKING_FEE", DbType.Decimal, 30, poNewEntity.NBOOKING_FEE);
                loDb.R_AddCommandParameter(loCommand, "@CTC_CODE", DbType.String, 32, poNewEntity.CTC_CODE);
                */
