...
public partial class PMT01800 : R_Page
{
    ...
    private async Task OnChangedProperty(object poParam)
    {
        ...
        try
        {
            _viewModelPMT01800.propertyValue = lsProperty;
    ...
    private async Task OnchangeDate(DateTime? poParam)
    {
        var loEx = new R_Exception();

        try
        {
            _viewModelPMT01800.OfferDate = poParam;
    ...
    private void BeforeOpenPMT01100(R_BeforeOpenPopupEventArgs eventArgs)
    {
        var loEx = new R_Exception();
        try
        {
