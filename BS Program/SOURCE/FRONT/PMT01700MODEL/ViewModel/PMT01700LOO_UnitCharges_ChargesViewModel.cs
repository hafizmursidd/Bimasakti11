...
namespace PMT01700MODEL.ViewModel
{
    public class PMT01700LOO_UnitCharges_ChargesViewModel : R_ViewModel<PMT01700LOO_UnitCharges_ChargesDetailDTO>
    {
        ...
        #region Charges
        public async Task GetFeeMethodandPeriod()
        {
            ...
            try
            {
                ...
                if (loResult != null)
                {
                    oComboBoxPeriodMode = oComboBoxFeeMethod = loResult.Data;
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task GetChargesList()
        {
            ...
            try
            {
                ...
                R_FrontContext.R_SetStreamingContext(PMT01700ContextDTO.CUNIT_ID, oParameterChargeTab.COTHER_UNIT_ID);
                R_FrontContext.R_SetStreamingContext(PMT01700ContextDTO.CFLOOR_ID, oParameterChargeTab.CFLOOR_ID);
                R_FrontContext.R_SetStreamingContext(PMT01700ContextDTO.CBUILDING_ID, oParameterChargeTab.CBUILDING_ID);
