...
namespace CBT02300FRONT
{
    public partial class CBT02300
    {
        ...
        private void AfterDock_InstantiateDock(R_AfterOpenPredefinedDockEventArgs eventArgs)
        {
        ...
        private async Task BankInBtn()
        {
            ...
            try
            {
                ...
                await _conductorBankInChequeRef!.R_SaveBatch();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task ServiceSaveBatch(R_ServiceSaveBatchEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (await R_MessageBox.Show("Confirmation", 
                    $"Are you sure want to {_lcType} selected cheque(s)?",
