        ...
        private async Task OnLostFocusTenant()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!string.IsNullOrEmpty(_viewModel.TenantDetail.CTENANT_ID))
                    {
                        loGetData.CADDRESS = _viewModel.TenantDetail.CADDRESS;
                        loGetData.CEMAIL = _viewModel.TenantDetail.CEMAIL;
                        loGetData.CPHONE1 = _viewModel.TenantDetail.CPHONE1;
                        loGetData.CPHONE2 = _viewModel.TenantDetail.CPHONE2;
                        loGetData.CTENANT_CATEGORY_ID = _viewModel.TenantDetail.CTENANT_CATEGORY_ID;
                        loGetData.CATTENTION1_NAME = _viewModel.TenantDetail.CATTENTION1_NAME;
                        loGetData.CATTENTION1_EMAIL = _viewModel.TenantDetail.CATTENTION1_EMAIL;
                        loGetData.CATTENTION1_MOBILE_PHONE1 = _viewModel.TenantDetail.CATTENTION1_MOBILE_PHONE1;
                        loGetData.CSALESMAN_ID = _viewModel.TenantDetail.CSALESMAN_ID;
                        loGetData.CTAX_TYPE = _viewModel.TenantDetail.CTAX_TYPE;
                        loGetData.CTAX_ID = _viewModel.TenantDetail.CTAX_ID;
                        loGetData.CTAX_NAME = _viewModel.TenantDetail.CTAX_NAME;
                        loGetData.CID_TYPE = _viewModel.TenantDetail.CID_TYPE;
                        loGetData.CID_NO = _viewModel.TenantDetail.CID_NO;
                        loGetData.CID_EXPIRED_DATE = _viewModel.TenantDetail.CID_EXPIRED_DATE;
                        loGetData.CTAX_ADDRESS = _viewModel.TenantDetail.CTAX_ADDRESS;
                    };
                }
            }
            catch (Exception ex)
